...
public class FloatLogo extends Service implements View.OnClickListener {
    ...
    void createOver(){
        ...
        final Button playerBtn=mFloatingView.findViewById(R.id.playerBtn);
        final Button itemBtn=mFloatingView.findViewById(R.id.itemBtn);
        final Button vehicleBtn=mFloatingView.findViewById(R.id.vehicleBtn);
        final Button settingsBtn=mFloatingView.findViewById(R.id.SettingsBtn);
        ...
        playerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemBtn.setBackgroundResource(R.drawable.weapon_or);
                playerBtn.setBackgroundResource(R.drawable.eye_on_click);
                vehicleBtn.setBackgroundResource(R.drawable.car_or);
                settingsBtn.setBackgroundResource(R.drawable.setting_or);
        ...
        itemBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemBtn.setBackgroundResource(R.drawable.weapon_on_click);
                playerBtn.setBackgroundResource(R.drawable.eye_or);
                vehicleBtn.setBackgroundResource(R.drawable.car_or);
                settingsBtn.setBackgroundResource(R.drawable.setting_or);
        ...
        vehicleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                itemBtn.setBackgroundResource(R.drawable.weapon_or);
                playerBtn.setBackgroundResource(R.drawable.eye_or);
                vehicleBtn.setBackgroundResource(R.drawable.car_on_click);
                settingsBtn.setBackgroundResource(R.drawable.setting_or);
                items.setVisibility(View.GONE);
                player.setVisibility(View.GONE);
        ...
        settingsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                playerBtn.setBackgroundResource(R.drawable.eye_or);
                vehicleBtn.setBackgroundResource(R.drawable.car_or);
                settingsBtn.setBackgroundResource(R.drawable.setting_on_click);
                items.setVisibility(View.GONE);
                player.setVisibility(View.GONE);
                vehicle.setVisibility(View.GONE);
